...
class Transaksi extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        // Find and return a single record for a particular user.
            ...
            $this->db->query("select * from transaksi t join penyewa p on p.id_penyewa = t.id_penyewa join kamar k on k.id_kamar = t.id_kamar order by t.id_transaksi DESC");
